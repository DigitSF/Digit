...
const string strMessageMagic = "Digit Signed Message:\n";
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "Digit", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (fTestNet)
    {
        ...
        bnProofOfWorkLimit = bnProofOfWorkLimitTestNet; // test net has PoW target limit of 16
        nStakeMinAge = 8 * 60 * 60; // test net min age is 8 hours
        nCoinbaseMaturity = 10; // test maturity is 10 +10 blocks
    }
    else
    {
...
unsigned char pchMessageStart[4] = { 0x95, 0x90, 0x72, 0x26 };

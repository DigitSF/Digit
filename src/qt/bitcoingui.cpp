...
void BitcoinGUI::createActions()
{
    ...
    connect(aboutDSFAction, SIGNAL(triggered()), this, SLOT(aboutDSFClicked()));
...
void BitcoinGUI::aboutDSFClicked()
{
    QDesktopServices::openUrl(QUrl("http://www.digitpayment.org/faq"));
}
...
void BitcoinGUI::updateStakingIcon()
{
    ...
    if (nLastCoinStakeSearchInterval && nWeight)
    {
        ...
        labelStakingIcon->setToolTip(tr("Staking.<br>Wallet stake weight is %1<br>Network stake weight is %2<br>Expected time to earn interest is %3").arg(nWeight).arg(nNetworkWeight).arg(text));
    }
    else
    {
        ...
        if (pwalletMain && pwalletMain->IsLocked())
            ...
            labelStakingIcon->setToolTip(tr("Not staking. Wallet is offline"));
        else if (IsInitialBlockDownload())
            labelStakingIcon->setToolTip(tr("Not staking. Wallet is syncing"));
        else if (!nWeight)
            labelStakingIcon->setToolTip(tr("Not staking. No mature coins"));
        else

    ...
    model(0)
{
    ...
    ui->lineEditCoinControlChange->setPlaceholderText(tr("Enter a Digit address (e.g. dNDUayujTwLETzA7hpDRNFxFhqVsngusFf)"));
#endif
...
void SendCoinsDialog::on_sendButton_clicked()
{
    ...
    QMessageBox::StandardButton retval = QMessageBox::question(this, tr("Confirm Send Digit"),
    ...
    case WalletModel::InvalidAddress:
        QMessageBox::warning(this, tr("Send Digit"),
...
void SendCoinsDialog::coinControlChangeEdited(const QString & text)
{
    if (model)
    {
        ...
        else if (!CBitcoinAddress(text.toStdString()).IsValid())
        {
            ...
            ui->labelCoinControlChangeLabel->setText(tr("WARNING: Invalid Digit address"));
        }
        else
        {
